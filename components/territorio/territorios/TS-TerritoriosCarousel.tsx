      ...
      {Object.entries(items).map(([_, item]) => (
        <div class="text-center min-w-full flex flex-col gap-1">
          <div class="flex flex-col items-center">
            <div class="flex flex-col items-center justify-center max-w-[60%] sm:max-w-[50%] md:max-w-[40%]">
              <div class="flex justify-between items-center gap-x-8 mb-[26px] md:mb-4">
                <Image
                  src={item.image.src}
                  alt={item.image.alt}
                  width={82}
                ...
                <TsTypography
                  ...
                  class="text-[24px] leading-[24px] sm:text-5xl text-left max-w-[60%]"
                >
                  Território{" "}
              ...
              <div class="text-left">
                <TsRichText class="text-base-100 w-full font-body text-[14px] leading-[21px] sm:text-3xl md:text-2xl">
                  {item.description}
                </TsRichText>
              </div>
            </div>
